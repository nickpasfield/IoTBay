...
export default function contact() {
  const { hasCopied, onCopy } = useClipboard("customersupport@iotbay.com");
  const { hasCopied: hasCopiedphone, onCopy: onCopyPhone } =
    useClipboard("+61 470 770 162");
  const { hasCopied: hasCopiedLocation, onCopy: onCopyLocation } =
    useClipboard("Sydney, Australia");
  ...
  return (
    <Container
      ...
      bgGradient={"linear(to-t, gray.100, transparent), transparent)"}
      css={{
                ...
                <Wrap spacing={{ base: 20, sm: 3, md: 5, lg: 20 }}>
                  <WrapItem>
                    <Box alignItems={"center"}>
                      <Heading color="black">Contact Us Today</Heading>
                      {/* <Text mt={{ sm: 3, md: 3, lg: 5 }} color="black">
                        Fill up the form and submit
                      </Text> */}
                      <Box py={{ base: 5, sm: 5, md: 8, lg: 10 }} mt={5}>
                        <VStack pl={0} spacing={3} alignItems="center">
                          ...
                          >
                            <Button
                              ...
                              onClick={onCopy}
                            >
                              customersupport@iotbay.com
                            </Button>
                          </Tooltip>

                          <Tooltip
                            label={
                              hasCopiedphone ? "Phone Copied!" : "Copy Phone"
                            }
                            closeOnClick={false}
                            hasArrow
                          >
                      ...
                      >
                        <IconButton
                          ...
                          isRound={true}
                          _hover={{ bg: "white" }}
                          icon={<MdFacebook size="28px" color="grey" />}
                        />
                        <IconButton
                          aria-label="github"
                          variant="ghost"
                          ...
                          isRound={true}
                          _hover={{ bg: "white" }}
                          icon={<BsGithub size="28px" color="grey" />}
                          onClick={() =>
                            window.open("https://github.com/jeffcheng0124")
                          }
                        />
                        <IconButton
                          aria-label="discord"
                          ...
                          isRound={true}
                          _hover={{ bg: "white" }}
                          icon={<BsDiscord size="28px" color="grey" />}
                        />
                        <IconButton
                          aria-label="discord"
                          variant="ghost"
                          ...
                          isRound={true}
                          _hover={{ bg: "white" }}
                          icon={<BsInstagram size="28px" color="grey" />}
                        />
                      </HStack>
                    </Box>
                  </WrapItem>
